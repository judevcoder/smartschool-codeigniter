                                    ...
                                    foreach ($list as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                <a href="<?php echo base_url(); ?>admin/content/deleteassignment/<?php echo $data['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
