            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="date_edit" name="date" class="form-control" value="<?php
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="date_of_call_edit" name="follow_up_date"class="form-control" value="<?php
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo set_value('assigned', $enquiry_data['assigned']); ?>" name="assigned" class="form-control">
                    </div>
                </div>
...
<?php foreach ($source as $key => $value) { ?>
                                <option value="<?php echo $value['source']; ?>"<?php if (set_value('source', $enquiry_data['source']) == $value['source']) { ?>selected=""<?php } ?>><?php echo $value['source']; ?></option>
<?php }
?> 
                        </select>
                    </div>
...
?>
                ...
                <div class="col-sm-3">                
                    <div class="form-group">
                        <label for="pwd"><?php echo $this->lang->line('no_of_child'); ?></label> 
...
<div class="row">
    <div class="box-footer">
        <div class="pull-right paddA10">
            <a onclick="postRecord(<?php echo $enquiry_data['id'] ?>)" class="btn btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></a>
        </div>
    </div>
</div><!--./row-->
<script>
    var date_format = '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy',]) ?>';
    $('#date_of_call_edit').datepicker({
        //  format: "dd-mm-yyyy",
        format: date_format,
        autoclose: true
    });
