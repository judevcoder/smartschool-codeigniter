                                    ...
                                    <div class="panel box box-primary">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right">
                                                <?php if ($this->rbac->hasPrivilege('notice_board', 'can_edit')) { ?>
                                                    <a href="<?php echo base_url() ?>admin/notification/edit/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" data-original-title="<?php echo $this->lang->line('add'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    &nbsp; <?php } if ($this->rbac->hasPrivilege('notice_board', 'can_delete')) { ?>                                             <a href="<?php echo base_url() ?>admin/notification/delete/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" data-original-title="<?php echo $this->lang->line('add'); ?>">
