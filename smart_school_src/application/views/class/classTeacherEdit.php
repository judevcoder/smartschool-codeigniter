                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit') ?> <?php echo $this->lang->line('assign_class_teacher') ?></h3>

                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/teacher/update_class_teacher"  method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="section_id" name="section" disabled>
                                        <option value=""><?php echo $this->lang->line('select') ?></option> 
                                    </select>
    ...
    <?php echo $teacher["section"]; ?>
                                            ...
                                            <td class="mailbox-date pull-right"">
                                                ...
                                                if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/teacher/classteacheredit/<?php echo $teacher["class_id"]; ?>/<?php echo $teacher["section_id"]; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function (i, obj)
                    {
                        ...
                        div_data += "<option " + select + " value=" + obj.section_id + " >" + obj.section + "</option>";
                    });
