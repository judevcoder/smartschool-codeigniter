                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                           ...
                                                           <?php
                                                            ...
                                                            ?>
                                                           <input type="text" value="<?php echo $student["measurement_date"] ?>" id="measure_date" name="measure_date" class="form-control"  value="<?php echo set_value('measure_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['measurement_date']))); ?>">
