...
class Gallery extends Admin_Controller {
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Gallery added successfully</div>');
    ...
    function edit($slug) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Gallery updated successfully</div>');
            redirect('admin/front/gallery');
        }
    }
    ...
    function delete($id) {
        ...
        $this->cms_program_model->removeBySlug($id, 'gallery');
