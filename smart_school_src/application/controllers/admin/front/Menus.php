...
class Menus extends Admin_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Menu added successfully</div>');
    ...
    function edititem($slug, $top_menu) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->cms_menuitems_model->add($data);
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Menu Item 
