...
class Enquiry extends Admin_Controller {
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $array = array('status' => 'success', 'error' => '', 'message' => "Enquiry Saved Successfully");
        }
    ...
    public function delete($id) {
        ...
        if (!empty($id)) {
            ...
            $array = array('status' => 'success', 'error' => '', 'message' => "Enquiry Deleted Successfully");
        }
        echo json_encode($array);
        //$this->session->set_flashdata('msg', '<div class="alert alert-success">Enquiry deleted successfully</div>');
        //  redirect('admin/enquiry');
    }

    public function follow_up($enquiry_id) {
...
//print_r($data);
    ...
    function follow_up_insert() {
        ...
        $this->form_validation->set_rules('date', 'Follow Up Date', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $array = array('status' => 'success', 'error' => '', 'message' => "Follow Up Saved Successfully");
        }
    ...
    function details($id) {
        ...
        $data['enquiry_data'] = $this->enquiry_model->getenquiry_list($id);
    ...
    function editpost($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $array = array('status' => 'success', 'error' => '', 'message' => "Enquiry Updated Successfully");
        }

        echo json_encode($array);
        //$this->session->set_flashdata('msg', '<div class="alert alert-success">Enquiry updated successfully</div>');
        //redirect('admin/enquiry');
    }
    ...
    public function change_status() {
        ...
        if (!empty($id)) {
            ...
            $array = array('status' => 'success', 'error' => '', 'message' => "Status Updated Successfully");
        } else {

            $array = array('status' => 'fail', 'error' => '', 'message' => "Status Not Updated");
        }
