...
class studentidcard extends Admin_Controller {
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('address', 'Address/Phone/Email', 'trim|required|xss_clean');
        $this->form_validation->set_rules('title', 'ID Card Title', 'trim|required|xss_clean');
        //$this->form_validation->set_rules('sign_image', 'Signature Image', 'required');
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($_FILES['sign_image']['name'])) {
                ...
                $config['allowed_types'] = 'jpg|jpeg|png|gif';
                //  $config['file_name'] = $_FILES['sign_image']['name'];
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">ID Card added successfully</div>');
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">ID Card updated successfully</div>');
            redirect('admin/studentidcard/edit/' . $this->input->post('id'));
        }
    }
    ...
    function delete($id) {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Id Card deleted successfully</div>');
        redirect('admin/studentidcard/index');
    }
            ...
            <tr> 
                <td valign="top" width="32%" style="padding: 3px;">
                    <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                        <tr>
                            <td valign="top">
                                <img src="<?php echo base_url('uploads/student_id_card/background/') ?><?php echo $idcard->background; ?>" class="tcmybg" /></td>
                        </tr>
                        <tr>
                            <td valign="top">
