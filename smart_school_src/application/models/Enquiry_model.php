...
class enquiry_model extends CI_Model {
    ...
    public function getenquiry_list($id = null) {
        ...
        $query = $this->db->select('enquiry.*,classes.class as classname')->join("classes", "enquiry.class = classes.id", "left")->where('status', 'active')->order_by("enquiry.id", "desc")->get("enquiry");
    ...
    public function searchEnquiry($source, $status, $date_from, $date_to) {
